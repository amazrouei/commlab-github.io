...
let stories = [
    'Hello!',
    'I am a camel2, your storyteller.',
    'I am here to help you understand the world',
    'It is a fictional world, but a world nonetheless.'
];

let camel2Div = document.getElementById('camel2-div'); // Updated to camel2-div
let camel2Text = document.getElementById('camel2-text'); // Assuming camel2-text ID for consistency, update as necessary
...
function changeText(){
    ...
    // Set the text of camel2-text element depending on which section the user has currently scrolled to
    camel2Text.innerHTML = stories[sectionNum]; // Update as necessary if camel2-text doesn't exist
    // Map vertical scroll position to the horizontal position of the camel2
    camel2Div.style.left = pos / (height * 4) * width + 'px';
